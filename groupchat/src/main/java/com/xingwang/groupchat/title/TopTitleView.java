package com.xingwang.groupchat.title;
...
public class TopTitleView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        mMainLayout = inflate(getContext(), R.layout.groupchat_view_top_title, this);
    ...
    private void setupViews(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.groupchat_topTitle);
        try {
            setTitleBackground(a.getColor(
                    R.styleable.groupchat_topTitle_title_background_color,
                    ContextCompat.getColor(getContext(), R.color.reslib_colorWindowContentBalck)));
            setTitleText(a.getString(R.styleable.groupchat_topTitle_title_text));
            setTitleSize(a.getDimension(R.styleable.groupchat_topTitle_title_size, 20));
            setTitleColor(a.getColor(R.styleable.groupchat_topTitle_title_color, ContextCompat.getColor(getContext(), R.color.groupchat_white)));
            setLeftButtonBackground(a.getResourceId(R.styleable.groupchat_topTitle_left_button_background, R.drawable.groupchat_bg_title_img));
            int right_first_img = a.getResourceId(R.styleable.groupchat_topTitle_right_first_img, 0);
            String right_first_tv = a.getString(R.styleable.groupchat_topTitle_right_first_tv);
            setRightFirst(right_first_img, right_first_tv);
            setRightSecondImg(a.getResourceId(R.styleable.groupchat_topTitle_right_second_img, 0));
            isShowSeondImg(a.getBoolean(R.styleable.groupchat_topTitle_is_show_right_second, true));
            isShowBack(a.getBoolean(R.styleable.groupchat_topTitle_title_is_show_back, true));
        } finally {
            a.recycle();
        }
    }
